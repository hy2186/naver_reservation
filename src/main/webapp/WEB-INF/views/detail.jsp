...
<head>
    ...
    <script src="/reservation/resources/js/detailPage/detail.js" type="module"></script>
    <script src="/reservation/resources/js/detailPage/reviewView.js" type="text/javascript"></script>
...
<body>
                ...
                <div class="section_visual">
                    ...
                    <div class="pagination">
                        ...
                        <div class="figure_pagination">
                            <span id="current_page" class="num">1</span>
                            <span class="num off">/ <span id="total_page"></span></span>
                        </div>
                    </div>
                    <div class="group_visual">
                        <div>
                            <div class="container_visual" style="width: 414px;">
                                <ul id="detail_slider" class="visual_img detail_swipe">
                                </ul>
                            </div>
                            <div class="prev">
                                <div class="prev_inn">
                                    <a id="prev_page_button" class="btn_prev" title="이전">
                            ...
                            <div class="nxt">
                                <div class="nxt_inn">
                                    <a id="next_page_button" class="btn_nxt" title="다음">
                                        <i class="spr_book2 ico_arr6_rt off"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="section_event">
                    <div class="event_info_box">
                        ...
                        <div class="event_info">
                            <div class="in_dsc"><div id="event_description"></div></div>
                        </div>
                    </div>
                </div>
                <div class="section_btn">
                    <a id="reserve_button" href="javascript:history.back()"> <button type="button" class="bk_btn"> <i class="fn fn-nbooking-calender2"></i> <span>예매하기</span> </button></a>  
                </div>
                    ...
                    <div class="review_box">
                        ...
                        <div class="short_review_area">
                            <div class="grade_area">
                                ...
                                <span class="graph_mask"> <em id="review_graph" class="graph_value" style="width: 0%;"></em> </span>
                                <strong class="text_value"> <span id="review_score"></span> <em class="total">5.0</em> </strong>
                                <span class="join_count"><em id="review_count" class="green"></em> 등록</span>
                            </div>
                            <ul id="short_review_list" class="list_short_review">
                            </ul>
                        </div>
                        <p class="guide"> <i class="spr_book2 ico_bell"></i> <span>네이버 예약을 통해 실제 방문한 이용자가 남긴 평가입니다.</span> </p>
                    </div>
                    <a id="review_more_button" class="btn_review_more" href=""> <span>예매자 한줄평 더보기</span> <i class="fn fn-forward1"></i> </a>
                </div>
                <div class="section_info_tab">
                    <!-- [D] tab 선택 시 anchor에 active 추가 -->
                    <ul id="detail_tab" class="info_tab_lst">
                        ...
                        <div class="detail_info">
                                ...
                                <ul class="detail_info_group">
                                    <li class="detail_info_lst">
                                        ...
                                        <p id="detail_content" class="in_dsc">
                                        </p>
                                    </li>
                    ...
                    <div class="detail_location hide">
                        <div class="box_store_info no_topline">
                            <a class="store_location" title="지도웹으로 연결">
                                <img id="store_map" class="store_map img_thumb" alt="map" src="https://simg.pstatic.net/static.map/image?version=1.1&amp;crs=EPSG:4326&amp;baselayer=bl_vc_bg&amp;exception=xml&amp;scale=2&amp;caller=mw_smart_booking&amp;overlayers=ol_vc_an&amp;center=127.0011948,37.5717079&amp;markers=type,default2,127.0011948,37.5717079&amp;level=11&amp;w=340&amp;h=150">
                                <span class="img_border"></span>
                                <span class="btn_map"><i class="spr_book2 ico_mapview"></i></span>
                            </a>
                            <h3 id="stroe_name" class="store_name"></h3>
                            <div class="store_info">
                                <div class="store_addr_wrap">
                                    <span class="fn fn-pin2"></span>
                                    <p id="store_addr" class="store_addr store_addr_bold"></p>
                                    <p class="store_addr">
                                        <span class="addr_old">지번</span>
                                        <span id="store_old_addr" class="addr_old_detail"></span>
                                    </p>
                                    <p id="store_addr_detail" class="store_addr addr_detail"></p>
                                </div>
                                <div class="lst_store_info_wrap">
                                    <ul class="lst_store_info">
                                        <li class="item"> <span class="item_lt"> <i class="fn fn-call2"></i> <span class="sr_only">전화번호</span> </span> <span class="item_rt"> <a id="store_tel" class="store_tel"></a></span> </li>
                                    </ul>
                                </div>
                            </div>
    ...
    <script type="dt-template" id="slider_item_template">
        {{#each productImages}}
        <li class="item" style="width: 414px"> <img alt="productImage" class="img_thumb" src="/reservation/download/image/{{fileId}}"> <span class="img_bg"></span>
    ...
    <script type="dt-template" id="review_template">
        {{#each comments}}
        <li class="list_item">
            <div>
                {{#if commentImages}}
                <div class="review_area">
                    <div class="thumb_area">
                        <a class="thumb" title="이미지 크게 보기">
                            <img width="90" height="90" class="img_vertical_top" src="/reservation/download/image/{{fileId commentImages}}" alt="리뷰이미지"> 
                        </a>
                ...
                <div class="info_area">
                    <div class="review_info">
                        <span class="grade">{{score this}}</span>
                        <span class="name">{{reservationEmail}}</span>
                        <span class="date">{{reservationDate this}} 방문</span>
                    </div>
                </div>
            </div>
        </li>
