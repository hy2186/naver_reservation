...
<head>
    ...
    <script src="/reservation/resources/js/reservePage/reserve.js" type="module"></script>
...
<body>
        ...
        <div class="ct">
            <div class="ct_wrap">
                <div class="top_title">
                    ...
                    <h2><span id="reservation_title" class="title"></span></h2>
                </div>
                <div class="group_visual">
                    <div class="container_visual" style="width: 414px;">
                        <ul class="visual_img">
                            <li class="item" style="width: 414px;"> <img id="product_image" alt="상품정보" class="img_thumb" src="https://ssl.phinf.net/naverbooking/20170217_264/1487312141947lTddT_JPEG/%B3%D7%C0%CC%B9%F6.jpg?type=ff1242_816"> <span class="img_bg"></span>
                                <div class="preview_txt">
                                    <h2 class="preview_txt_tit"></h2> <em id="product_image_price" class="preview_txt_dsc">₩</em><em id="product_image_opening" class="preview_txt_dsc">2017.2.17.(금)~2017.4.18.(화), 잔여티켓 2769매</em> </div>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="section_store_details">
                    <div class="store_details">
                        <h3 class="in_tit"></h3>
                        <p class="dsc">
                            장소 : <span id="product_location"></span> <br> 기간 : <span id ="product_period">2017.2.17.(금)~2017.4.18.(화)</span> 
                        </p>
                        <h3 class="in_tit">관람시간</h3>
                        <p id="opening_hour" class="dsc">
                            화, 목, 금 일요일 10:00am~06:00pm(입장마감 05:30pm)<br> ‘문화가 있는 날’ 매월 마지막 주 수요일은 오후 8시까지 연장
                        </p>
                        <h3 class="in_tit">요금</h3>
                        <p id="price_description" class="dsc">
                        ...
                        <div class="form_wrap">
                            ...
                            <form class="form_horizontal">
                                <div class="inline_form"> <label class="label" for="name"> <span class="spr_book ico_nessasary">필수</span> <span>예매자</span> </label>
                                    <div id="name_input" class="inline_control name_wrap"> 
                                        <input type="text" name="name" id="name" class="text" value="" placeholder="네이버" maxlength="17"> 
                                        <div class="warning_msg">이름 형식이 아니에요</div>
                                    </div>
                                </div>
                                <div class="inline_form"> <label class="label" for="tel"> <span class="spr_book ico_nessasary">필수</span> <span>연락처</span> </label>
                                    <div id="tele_input" class="inline_control tel_wrap">
                                        <input type="tel" name="tel" id="tel" class="tel" value="" placeholder="휴대폰 입력 시 예매내역 문자발송">
                                        <div class="warning_msg">전화번호 형식이 아니에요</div>
                                    </div>
                                </div>
                                <div class="inline_form"> <label class="label" for="email">  <span class="spr_book ico_nessasary">필수</span>  <span>이메일</span> </label>
                                    <div id="email_input" class="inline_control email_wrap"> 
                                        <input type="email" name="email" id="email" class="email" value="" placeholder="crong@codesquad.kr" maxlength="50">
                                        <div class="warning_msg">이메일 형식이 아니에요</div>
                                    </div>
                                </div>
                                <div class="inline_form last"> <label class="label" for="message">예매내용</label>
                                    <div class="inline_control">
                                        <p class="inline_txt selected"><span id="reservation_date" value="">${reservationDate}</span> 총 <span id="total_ticket_count" value="0">0</span>매</p>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="box_bk_btn">
                    ...
                    <div class="bk_btn_wrap disable"> <button type="button" class="bk_btn reserve_button"> <i class="spr_book ico_naver_s"></i>  <span>예약하기</span> </button> </div>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="dt-template" id="ticket_template">
        {{#each this}}
        <div class="qty ticket_item" data-product_price_id={{productPriceId}}>
            <div class="count_control">
                <div class="clearfix">
                    <a class="btn_plus_minus spr_book2 ico_minus3 minus_btn disabled" title="빼기"> </a>
                    <input type="tel" class="count_control_input disabled" value="0" readonly title="수량">
                    <a class="btn_plus_minus spr_book2 ico_plus3 plus_btn" title="더하기"></a>
                </div>
            ...
            <div class="qty_info_icon">
                <strong class="product_amount">
                    <span>{{priceTypeName this}}</span>
                </strong>
                <strong class="product_price">
                    <span class="price" value={{price}}>{{changePricePattern price}}</span>
                    <span class="price_type">원</span>
                </strong>
                <em class="product_dsc">{{changePricePattern price}}원 ({{discountRate}}% 할인가)</em>
            </div>
        </div>
        {{/each}}
    </script>
